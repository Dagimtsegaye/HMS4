...
<div class='container-fluid'>
   <div class = 'sidbar_border'>
        <nav class='navbar navebar-light bg-light justify-content-between'> 
            ...
            <i  id = 'open' class='fa fa-bars fa_item'></i>
           
            </span>
            <div class='hms'>  HMS  </div> </h1>          
                 <p class= 'znav'>Hospital Managemnt System</p>
                      <span class='form-inline'>                 
            <i  id = 'show_notfy' class='btnn4 fa fa-bell fa_item'></i>
            <div  class='hmss'> 5 </div>       
                          <p class="stuff">Doctor</p>
 ...
 <div id="mySidenav" class="sidenav">
    <div class = 'sidbar_border'>
    <span><i  class='fa fa-tachometer fa_item'></i> </span>          
              <div class='dashbord'><a class='zlink' href="{{ route('Doc_Dash') }}">DashBord</a></div>    
              <button class='btnn dropdown-toggle'><span><i  class='fa fa-user-md fa_item'></i> </span>Patients</button>                        
                        <div class='ccc'>
                            <div class='cc' > <a class='cc' href="{{ route('viewRecpPa') }}">App</a></div>
                            <div class='cc'> <a class='cc' href="{{ route('AddPa') }}">OPD</a></div>
                            <div class='cc'> <a class='cc' href="{{ route('AddPa') }}">IPD</a></div>
                       </div>                                                     
        </div>
    </div>
