 ...
 <div id="mySidenav" class="sidenav">
    <div class = 'sidbar_border'>
            <span><i  class='fa fa-tachometer'></i> </span>          
              <div class='dashbord'><a class='zlink' href="{{ route('Admin_Dash') }}">DashBord</a></div>    
                    <button class='btnn dropdown-toggle'><span><i  class='fa fa-user-md'></i> </span> Docturs</button>
                        <div class='ccc'>
                            <div class='cc' > <a class='cc' href='#'>View</a></div>
                            <div class='cc'> <a class='cc' href='#'>Manage</a></div>
                        </div>
                        
               <button class='btnn2 dropdown-toggle'><span><i  class='fa fa-plus'></i> </span>Labratory</button>
                    <div class='ccc2'>
                                    <div class='cc'><a class='cc' href='#'>View</a></div>
                                    <div class='cc'> <a class='cc' href='#'>Manage</a></div>                                      
                     </div>
               <button class='btnn3 dropdown-toggle'><span><i  class='fa fa-calendar-check-o'></i> </span>receprtion</button> 
                   <div class='ccc3'>
                                    <div class='cc'><a  class='cc' href='#'>View</a></div>
                                    <div class='cc'> <a class='cc' href='#'>Manage</a></div>                                      
                 </div>       
...
$(document).ready(function(){   
    ...
    $('.btnn2').click(function(){
        $('.ccc2').toggleClass("item2");  
    });
    $('.btnn3').click(function(){
        $('.ccc3').toggleClass("item2");  
    });
