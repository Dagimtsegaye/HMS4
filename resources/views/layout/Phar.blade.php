...
<div class='container-fluid'>
 ...
 <div id="mySidenav" class="sidenav">
    ...
    <span><i  class='fa fa-tachometer'></i> </span>          
              <div class='dashbord'><a class='zlink' href="{{ route('Phar_Dash') }}">DashBord</a></div>    
              <button class='btnn dropdown-toggle'><span><i  class='fa fa-user-md'></i> </span>Patients</button>                        
                        <div class='ccc'>
