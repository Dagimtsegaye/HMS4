...
<div class='container-fluid'>
 ...
 <div id="mySidenav" class="sidenav">
    ...
    <span><i  class='fa fa-tachometer fa_item'></i> </span>          
              <div class='dashbord'><a class='zlink' href="{{ route('Lab_Dash') }}">DashBord</a></div>    
              <button class='btnn dropdown-toggle'><span><i  class='fa fa-user-md fa_item'></i> </span>Patients</button>                        
                        <div class='ccc'>
                            <div class='cc' > <a class='cc' href="{{ route('viewRecpPa') }}">Wating</a></div>
                            <div class='cc'> <a class='cc' href="{{ route('AddPa') }}">Confirmed</a></div>
